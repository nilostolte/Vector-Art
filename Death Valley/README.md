...
in the circle with radius **r1**. Also of note that any number of _spikes_ can be generated by just initializing **ia** with 
different values that should be multiple of **360**.
